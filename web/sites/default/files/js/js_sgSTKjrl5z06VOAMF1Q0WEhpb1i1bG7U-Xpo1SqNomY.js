...
(function ($, Drupal, drupalSettings) {
	...
	jQuery("input#edit-pap-patients-dob").attr('max', '9999-12-31');
        jQuery( ".pap_wraper" ).each(function( index ) {
            $errdiv = jQuery(this).children(".gds_cstm_err");
            $appdto = jQuery(this).find(".gds-form-input .gds-form-validation-message .gds-paragraph");
            $errinput = jQuery(this).find(".gds-form-input__inner .gds-form-input__input-wrapper input");
            jQuery($errdiv).appendTo($appdto);
        });
        
        $("#edit-save").click(function (event) {
            $txt_prescription_value=$('#edit-pap-phone-number').val();
            $txt_dbo_value=$('#edit-pap-patients-dob').val();
            $txt_shipping_value=$('#edit-pap-shipping-zip').val();
            const regrex_number=/[009]{3}[0-9]{7}/;
            var pattern = /(0\d{1}|1[0-2])\/([0-2]\d{1}|3[0-1])\/(19|20)\d{2}/;
		var zip_num=/^[0-9]{1,5}$/;
            const pap_zipping_number_regex=/[0-9]{5}/;
            var error_status = false;
             
            if($txt_prescription_value ==''){
                $('#edit-pap-phone-number').addClass("custom-is-error");
                $('#pap_phone_number').html('The number must be 10 digits beginning with 009');
              $("span#pap_phone_number").parents(".gds-form-validation-message").removeClass("gds-form-validation-message--is-hidden");
               error_status = true;
                  }
            else if(!regrex_number.test($txt_prescription_value)){
                $('#edit-pap-phone-number').addClass("custom-is-error");
                $('#pap_phone_number').html('The number must be 10 digits beginning with 009');
             $("span#pap_phone_number").parents(".gds-form-validation-message").removeClass("gds-form-validation-message--is-hidden");
              error_status = true;
               }
                    else if($txt_prescription_value.length >10){
                    $('#edit-pap-phone-number').addClass("custom-is-error");
                    $('#pap_phone_number').html('The number must be 10 digits beginning with 009');
                    $("span#pap_phone_number").parents(".gds-form-validation-message").removeClass("gds-form-validation-message--is-hidden");
                    error_status = true;
                ...
                $("span#pap_phone_number").parents(".gds-form-validation-message").addClass("gds-form-validation-message--is-hidden");
                $('#pap_phone_number').html('');
               $('#edit-pap-phone-number').removeClass("custom-is-error");
                           
  }
            
	     if(!pattern.test($txt_dbo_value)){
                $('#edit-pap-patients-dob').addClass("custom-is-error");
                $('#pap_patients_dob').html('You must type the / symbol between the 2 digits for month, 2 digits for day and 4 digits for year');
                $("span#pap_patients_dob").parents(".gds-form-validation-message").removeClass("gds-form-validation-message--is-hidden");
                error_status = true;
            } else {
                $("span#pap_patients_dob").parents(".gds-form-validation-message").addClass("gds-form-validation-message--is-hidden");
                $('#edit-pap-patients-dob').removeClass("custom-is-error");
            }

            if( !zip_num.test($txt_shipping_value)){
  
                    $('#edit-pap-shipping-zip').addClass("custom-is-error");
                    $('#pap_shipping_zip').html('The zip code must be 5 digits');
                    jQuery("#pap_shipping_zip").parents(".gds-form-validation-message").removeClass("gds-form-validation-message--is-hidden");
                    error_status = true;
                }
		 else  if( $txt_shipping_value.length != '5'){
                        $('#edit-pap-shipping-zip').addClass("custom-is-error");
                        $('#pap_shipping_zip').html('The zip code must be 5 digits');
                        jQuery("#pap_shipping_zip").parents(".gds-form-validation-message").removeClass("gds-form-validation-message--is-hidden");
                        error_status = true;
                    ...
                    $('#edit-pap-shipping-zip').removeClass("custom-is-error");
                    $("#pap_shipping_zip").parents(".gds-form-validation-message").addClass("gds-form-validation-message--is-hidden");
                }
        ...
        $("#pap_reset_button").click(function () {
               //alert('kkk');
            $('#pap_phone_number').html('');
            $('#pap_patients_dob').html('');
            $('#pap_shipping_zip').html('');
            $('input#edit-pap-patients-dob').removeClass("custom-is-error");
            $('input#edit-pap-phone-number').removeClass("custom-is-error");
            $('input#edit-pap-shipping-zip').removeClass("custom-is-error");
            $("span#pap_phone_number").parents(".gds-form-validation-message").addClass("gds-form-validation-message--is-hidden");
            $("span#pap_patients_dob").parents(".gds-form-validation-message").addClass("gds-form-validation-message--is-hidden");
            jQuery("span#pap_shipping_zip").parents(".gds-form-validation-message").addClass("gds-form-validation-message--is-hidden"); 
